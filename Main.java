...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Person person = new Person(nameCheck,genderCheck, ageCheck, weightCheck, heightCheck);

        //Run BMRCalculation class from BMRCalculation.java
        BMRCalculator bmrCalculator = new BMRCalculator(person);
        ...
        CalorieCalculator calorieCalculator = new CalorieCalculator(userBMR, userActivityLevel, bodyGoalCheck);
